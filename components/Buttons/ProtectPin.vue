...
export default {
    methods: {
        OpenProtectPost() {
            ...
            if (post != null) {
                post.classList.remove('post-inactive');
            }
        }
    }
}
